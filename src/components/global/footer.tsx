  ...
  <footer className="bg-[#cc0c0c]  rounded-t-3xl  relative overflow-hidden">
    ...
    <div className="main-container px-5">
      <div className="grid grid-cols-12 xl:pt-[90px] gap-x-0 gap-y-16 pt-16 pb-12 justify-between">
        ...
        <div className="col-span-12 xl:col-span-4">
          <div className="max-w-[150px]">
            <figure>
              <img src="/logo.png" alt="NextSass Logo" />
            </figure>
            <p className="text-accent/60 font-normal text-tagline-1 mt-4 mb-7">
            With CLT Trading Journal, transform raw trades into data-driven mastery
            </p>
          ...
          {footerMenus.map((menu, idx) => (
            <div key={menu.title} className="col-span-12 md:col-span-4">
              <div className="space-y-8">
                <p className="sm:text-heading-6 text-tagline-1 font-normal text-white">
                  {menu.title}
                </p>
                <ul className="sm:space-y-5 text-white space-y-3">
                  {menu.links.map((link) => (
                    <li style={{color:""}} key={link.name}>
                      <a href={link.href} className="footer-link text-accent/60  ">
                        {link.name}
                      </a>
                    </li>
                  ))}
      ...
      <div className="pt-[26px] pb-[100px] text-center relative">
        ...
        <p className="text-tagline-1 font-normal text-accent/60">
          Copyright ©Abshar777
        </p>
      </div>
    </div>
